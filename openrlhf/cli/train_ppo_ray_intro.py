...
def train(args):
    ...
    if args.critic_pretrain and args.colocate_critic_reward:
        ...
        ), f"num_nodes and num_gpus_per_node must be the same when colocate critic and reward model."  #####we are using rule-based rewar model
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--advantage_estimator",
        type=str,
        choices=["gae", "reinforce", "rloo", "reinforce_baseline", "group_norm","intro"],
        default="gae",
        help="Choose advantage estimation method: gae, reinforce, rloo, reinforce_baseline, group_norm, intro",
    )
    ...
    if args.advantage_estimator in ["rloo", "reinforce_baseline", "group_norm","intro"]:
