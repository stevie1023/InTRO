    ...
    def fit(self, args, consumed_samples=0, num_update_steps_per_epoch=None):
        ...
        for epoch in range(start_epoch, self.epochs):
            ...
            for prompt_id_lens, inputs, attention_masks, infos in self.train_dataloader:
                ...
                step += 1
            self.strategy.save_model(self.model, self.tokenizer, f"{self.args.save_path}/epoch_{epoch}")
            epoch_bar.update()
    ...
    def save_logs_and_checkpoints(self, args, global_step, step_bar, logs_dict={}, client_states={}):
        ...
        # Save logs to a local JSONL file
            if self.strategy.is_rank_0():
                log_entry = {**logs_dict, "global_step": global_step}
                log_file_path = os.path.join(args.save_path, "training_logs.jsonl")
